...
<body class="fenetre">
  ...
  if(!$result) {
    ...
    if(mysqli_num_rows($result)==0) {
      ...
      echo "<p class='tip'>Cliquez sur le nom d'un élève pour en afficher son planning.</p>
        <div class='jstest'>
      ...
      while ($row = mysqli_fetch_array($result)) {
        echo "<a href='visualiser_calendrier_eleve.php?ideleve=$row[0]'><li class='list maj'>$row[2] $row[1]</li></a>";
      }
      echo "</ul>";
    }
  }
